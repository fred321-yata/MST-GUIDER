// Sample the sheet's colors to find what the drawing ink actually looks like.
...
// Histogram all sheet colors bucketed to 32-steps.
const hist = new Map()
...
console.log('sheet color histogram (bucket=32, % of sampled pixels):')
for (const [key, count] of [...hist.entries()].sort((a, b) => b[1] - a[1]).slice(0, 12)) {
